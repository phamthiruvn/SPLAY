...
abstract class AbstractSplayTreeTest {
    ...
    protected fun doRemoveTest() {
        ...
        for (iteration in 1..100) {
            ...
            assertEquals(
                expectedSize, splaySet.size,
                "The size of the tree is incorrect: was ${splaySet.size}, should've been $expectedSize."
            )
            for (element in controlSet) {
                assertTrue(
                    splaySet.contains(element),
